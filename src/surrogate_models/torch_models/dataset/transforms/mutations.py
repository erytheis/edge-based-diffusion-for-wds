...
from src.surrogate_models.torch_models.data.complex import get_upper_laplacian_sparse, ComplexData
from src.surrogate_models.torch_models.data.simplex import get_lower_boundary_and_laplacian, SimplexData
...
class ToComplexData(BaseTransform):
    ...
    def forward(self, data, *args, **kwargs):
        ...
        L1_up_i, L1_up_v = get_upper_laplacian_sparse(data, device=data.x.device,
                                                    )
